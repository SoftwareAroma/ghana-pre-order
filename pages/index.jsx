    ...
    return (
        <>
            ...
            <main className="w-full h-full">
                ...
                <div className="relative h-96 object-contain m-0 p-0">
                    <video autoPlay muted loop className="object-cover h-96 w-full absolute">
                    ...
                    <div className="absolute bottom-0 bg-white bg-opacity-75 w-full px-5 mx-auto">
                        <section className="text-gray-600 body-font">
                            <div className="container px-5 py-1 md:py-12 mx-auto">
                                <div className="grid grid-cols-2 gap-1 md:flex md:flex-wrap -m-4 text-center">
                                    ...
                                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                            ...
                                            <h2 className="title-font font-medium text-3xl text-gray-900 font-black">1.8</h2>
